        ...
        children: List.generate(
          ...
          (index) => Expanded(
            child: GestureDetector(
              ...
              child: Container(
                padding: const EdgeInsets.symmetric(vertical: SizeAsset.spacing/1.8),
                decoration: BoxDecoration(
                  color: selectedIndex == index ? kLightSurfacePrimary:Colors.transparent,
                  borderRadius: BorderRadius.circular(SizeAsset.spacing/2),
                  border: selectedIndex == index ? Border.all(color: kLightStroke) : null,
                ),
