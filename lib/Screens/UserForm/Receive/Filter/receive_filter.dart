import 'package:x_express/Screens/UserForm/Receive/Filter/receive_filter_result.dart';
import 'package:x_express/Utils/exports.dart';
import 'package:intl/intl.dart';

class ReceiveFilterScreen extends StatefulWidget {
  final type;
  const ReceiveFilterScreen({Key? key, required this.type}) : super(key: key);

  @override
  State<ReceiveFilterScreen> createState() => _ReceiveFilterScreenState();
}

class _ReceiveFilterScreenState extends State<ReceiveFilterScreen> {
  final receiveNoController = TextEditingController();
                  ...
                  child: Column(
                    ...
                    children: AnimationConfiguration.toStaggeredList(
                      ...
                      children: [
                              ...
                              suffix: IconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  Navigator.of(context).push(MaterialPageRoute(
                                      builder: (ctx) => ReceiveFilterResultScreen(
                                            e_date: e_date,
                                            s_date: s_date,
                                            customer: customerId,
                                            orderNo: orderNoController.text,
                                            receiveNo: receiveNoController.text,
                                          )));
                                },
                              ),
                              hintText: "",
                        ...
                        //     builder: (ctx, receive, _) => FutureBuilder(
                        ...
                        //                       onPressed: () {
                        //                         receive
                        //                           ..setWarehouseValue(warehouse.warehouseList[index].id.toString());
                        //                       },
                        //                       label: Text(
                        //                         warehouse.warehouseList[index].name!,
                        //
                        //                           color: AppTheme.black,
                        //                           fontSize: 13,
                        //                           fontFamily: 'nrt-reg',
                        ...
                        //                       ),
                        //                       selected:
                        //                           warehouse.warehouseList[index].id.toString() == receive.warehouseValue
                        //                               ? true
                        //                               : false,
                        //                     ),
                        //                   );
