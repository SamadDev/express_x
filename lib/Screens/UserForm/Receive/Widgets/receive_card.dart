...
class OrderReceiveCard extends StatelessWidget {
  ...
  OrderReceiveCard({required this.orderReceive, this.type,required this.length,required this.index});
  @override
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 3),
                            GlobalText(text:
                              orderReceive.customerName ?? "",
                              fontSize: 17, fontWeight: FontWeight.bold, color: AppTheme.grey_thin,
                            ),
                          ],
                        ),
                      ),
                      GlobalText(text:
                        orderReceive.receiveNo.toString() ?? "",
                       fontWeight: FontWeight.bold, color: AppTheme.grey_thin, fontSize: 15,
                      ),
                      SizedBox(width: 8)
                    ],
                  ),
                    ...
                    Column(
                      children: [
                        GlobalText(text:
                          ...
                          fontFamily: 'nrt-bold',fontWeight: FontWeight.bold, fontSize: 18, color: Colors.purple,
                        ),
                        SizedBox(height: 8),
                        GlobalText(text:DateFormat("dd-MM-yyyy").format(DateTime.parse(orderReceive.receiveDate.toString())),
                            fontSize: 17, fontFamily: "nrt-bold",  fontWeight: FontWeight.bold,color: AppTheme.grey_between,)
                      ],
                    ),
                    Spacer(),
                    Column(
