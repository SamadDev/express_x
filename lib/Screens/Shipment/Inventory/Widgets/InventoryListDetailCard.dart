...
class InventoryListDetailCard extends StatelessWidget {
  final InventoryListDetailModule inventory;
  final index;
  final length;
  InventoryListDetailCard({required this.inventory, this.index, this.length});
  @override
        ...
        children: [
          Row(
            ...
            children: [
              ...
              if (!inventory.customerCode.toString().startsWith("0") && inventory.customerCode != null) ...[
                Column(
                  children: [
                    SizedBox(height: 8),
                    GlobalText(
                      text: "${DateFormat("yyyy-MM-dd").format(DateTime.parse(inventory.receiveDate.toString()))}",
                      fontSize: 13,
                      fontFamily: 'nrt-reg',
            ...
            child: Row(
              ...
              children: [
                _StatisticCard(
                  ...
                  type: "",
                  value: formatQuantity(inventory.totalQty ?? 0),
                ),
                VerticalDivider(
                  thickness: 1.1,
