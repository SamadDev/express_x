import 'package:x_express/Screens/Receipt/Receipt%20Filter/currency_filter_result.dart';
import 'package:x_express/Utils/exports.dart';
import 'package:x_express/Widgets/dropdownbuttonWidget.dart';

class ReceiptFilterScreen extends StatefulWidget {
  const ReceiptFilterScreen({Key? key}) : super(key: key);

  @override
  State<ReceiptFilterScreen> createState() => _ReceiptFilterScreenState();
}

class _ReceiptFilterScreenState extends State<ReceiptFilterScreen> {
                            ...
                            suffix: IconButton(
                              ...
                              onPressed: () async {
                                ...
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (ctx) => ReceiptFilterResultScreen(
                                          e_date: e_date,
                                          s_date: s_date,
                                          docNo: receiptController.text,
                                        )));
                              },
                            ),
                            hintText: "",
