import 'package:x_express/Screens/Activity/ActivityFilter/activity_filter_result.dart';
import 'package:x_express/Utils/exports.dart';
import 'package:x_express/Widgets/dropdownbuttonWidget.dart';
import 'package:intl/intl.dart';

class ActivityFilterScreen extends StatefulWidget {
  const ActivityFilterScreen({Key? key}) : super(key: key);
                        ...
                        child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (ctx) => ActivityFilterResultScreen(
