...
class BagScreen extends StatelessWidget {
  ...
  Widget _buildBagItem(
      BuildContext context, BagItem item, BagService bagService) {
    return Container(
  ...
  Widget _buildCheckoutSection(
      BuildContext buildContext, BagService bagService) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: Colors.white,
    ...
    showDialog(
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          ...
          content: Text(
              'Are you sure you want to add this order with ${bagService.itemCount} item(s)?'),
          actions: [
            TextButton(
  ...
  void _processOrder(BuildContext context, BagService bagService) async {
    ...
    try {
      ...
      final result =
          await orderService.createOrderFromBagItems(bagService.bagItems);
